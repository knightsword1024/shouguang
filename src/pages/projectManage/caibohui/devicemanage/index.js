    ...
    return (
      ...
      >
        ...
        <div style={{ marginLeft: '110px' }}>
          <Button
            onClick={() => handleModalImportVisible(false)}
            style={{ marginLeft: '45%' }}
          >
            取消
          </Button>
...
class devicemanage extends Component {
  ...
  createColumns = () => [
    ...
    },
    {
      ...
      render: row => (
        <span>
          逻辑位置:{row.locationname}
          <br />
          物理位置:x:{row.x}&nbsp;y:{row.y}
        </span>
      )
    },
    {
      ...
      render: row => (
        <span
          style={{
            color:
              row.status == 1 ? 'rgba(126,211,33,0.85)' : 'rgba(252,4,10,0.85)'
          }}
        >
          {status[row.status]}
        </span>
    ...
    },
    {
      ...
      render: row => (
        <Fragment>
          ...
          <Divider type='vertical' />
          <a onClick={() => this.handleModalServeVisible(true, row)}>
            服务调用
          </a>
          <Divider type='vertical' />
              ...
              <Row gutter={10}>
                ...
                <Col span={4}>
                  <FormItem>
                    <Select
                      placeholder='所属网关'
                      onChange={this.onChange.bind(this, 'gatewayid')}
                    >
                ...
                <Col span={4}>
                  <FormItem>
                    <Select
                      placeholder='设备属性'
                      onChange={this.onChange.bind(this, 'devtyp')}
                    >
