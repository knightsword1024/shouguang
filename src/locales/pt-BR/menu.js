export default {
  ...
  'menu.heatingOptimization':'SeatingOptimization',
  'menu.energyConsumption':'EnergyConsumption',
  'menu.energyAnalysis':'EnergyAnalysis',
  'menu.energyMonitoring':'EnergyMonitoring',
  'menu.smartStrategy':'SmartStrategy',
